...
import com.lf.srb.core.enums.LendStatusEnum;
...
import com.lf.srb.core.mapper.LendItemMapper;
import com.lf.srb.core.mapper.LendMapper;
...
import com.lf.srb.core.service.*;
...
public class LendItemServiceImpl extends ServiceImpl<LendItemMapper, LendItem> implements LendItemService {
    ...
    public String commitInvest(InvestVO investVo) {
        ...
        lendItem.setLendEndDate(lend.getLendEndDate());//开始时间
        //预期收益
    ...
    public void notify(Map<String, Object> paramMap) {
       ...
       String agentBillNo = (String) paramMap.get("agentBillNo");
        ...
        //新增交易流水
        TransFlowBO transFlowBO = new TransFlowBO(agentBillNo, bindCode, new BigDecimal(voteAmt), TransTypeEnum.INVEST_LOCK,
